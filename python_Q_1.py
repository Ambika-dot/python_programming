...
Q.Write a python to find and display product of three positive integer values based on the rule mentioned below.It should display the product of the three values except when one of the
